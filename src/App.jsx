...
//                         className="flex-shrink-0 ml-4 mt-1 text-xs bg-yellow-500/20 text-yellow-300 font-semibold px-3 py-1 rounded-full flex items-center gap-1 hover:bg-yellow-500/30 transition-colors"
//                       >
//                         <Star size={14} />
